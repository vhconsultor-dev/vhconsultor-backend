...
public class CalculateFixedCommandValidator : AbstractValidator<CalculateFixedCommand>
{
    public CalculateFixedCommandValidator()
    {
        ...
        RuleFor(x => x.AnnualAdBudget)
            .GreaterThan(0).WithMessage("AnnualAdBudget debe ser mayor que 0");
    }
}
