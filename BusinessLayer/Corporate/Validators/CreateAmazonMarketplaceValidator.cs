...
/// <summary>
/// Validator for CreateAmazonMarketplaceRequest.
/// </summary>
public class CreateAmazonMarketplaceValidator : AbstractValidator<CreateAmazonMarketplaceRequest>
{
    public CreateAmazonMarketplaceValidator()
    {
