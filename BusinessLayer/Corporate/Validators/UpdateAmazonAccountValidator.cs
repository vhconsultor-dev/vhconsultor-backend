...
/// <summary>
/// Validator for UpdateAmazonAccountRequest.
/// </summary>
public class UpdateAmazonAccountValidator : AbstractValidator<UpdateAmazonAccountRequest>
{
    public UpdateAmazonAccountValidator()
    {
